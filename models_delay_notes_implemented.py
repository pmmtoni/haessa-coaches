...
class ProductionWorkLog(db.Model):
    ...
    production_stage = db.Column(db.String(100), nullable=True)
    workshop_station = db.Column(db.String(100), nullable=True)
    activity = db.Column(db.String(255), nullable=True)
    ...
    coach = db.relationship("Coach", backref=db.backref("production_work_logs", lazy=True))

    def __repr__(self):
        return f"<ProductionWorkLog coach={self.coach_id} date={self.work_date}>"
